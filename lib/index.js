  ...
  _createClass(GracefulImage, [{
    ...
    */
    ...
    value: function render() {
      ...
      if (!this.state.loaded && (this.props.noPlaceholder || !IS_SVG_SUPPORTED)) return null;else if (!this.state.loaded && this.state.fallbackImage) {
        var _style = {
        ...
        return _react2.default.createElement(
          "div",
          { style: { width: "" + this.props.width, height: "" + this.props.height, backgroundColor: '#f2f3f4', textAlign: 'center' } },
          _react2.default.createElement("img", {
            src: this.state.fallbackImage,
            className: this.props.className,
            width: "65px",
            height: "65px",
            style: _extends({}, _style, this.props.style),
            alt: this.props.alt,
          ...
          _react2.default.createElement(
            "div",
            { style: { fontSize: '14px', color: '#c1c7c9', paddingTop: '40px' } },
...
GracefulImage.propTypes = {
  ...
  fallbackMessage: _propTypes2.default.string,
