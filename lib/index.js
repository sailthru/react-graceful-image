  ...
  _createClass(GracefulImage, [{
    ...
    */
    ...
    value: function loadImage() {
      ...
      var image = new Image();
      if (this.useFallBackImageDirectly) image.onload = function () {
    ...
    */
    ...
    value: function render() {
      ...
      if (!this.state.loaded && (this.props.noPlaceholder || !IS_SVG_SUPPORTED)) return null;else if (!this.state.loaded && this.state.fallbackImage || this.state.useFallBackImageDirectly) {
        var _style = {
